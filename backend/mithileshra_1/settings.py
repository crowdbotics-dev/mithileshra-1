"""
Django settings for mithileshra_1 project.
...
ROOT_URLCONF = 'mithileshra_1.urls'
...
WSGI_APPLICATION = 'mithileshra_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithileshra_1 API",
    "DESCRIPTION": "API documentation for mithileshra_1 App",
    "VERSION": "v1",
}
